...
//   a better governance.
abstract contract CrunaProtectedNFTOwnable is CrunaProtectedNFTBase, Ownable2Step {
  error NotTheOwner();

  constructor(string memory name_, string memory symbol_, address admin) CrunaProtectedNFTBase(name_, symbol_) Ownable(admin) {}
